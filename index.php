...
<html lang="fr">
    ...
    <body>
        ...
        <section class="">
            <?php require("Script/Presentation/presentation.php"); ?>
        </section>
        
        <section class="">
          <div class="main" id="projet">
            <h4 class="title_cat">Mes projets</h4>
            <h5 class="desc_cat">Ce que j'ai réalisé.</h5>
            <div class="block">
              <div class="row">
                <?php require("Script/All_Projets/index.php"); ?>
            </div>
            </div>
          </div>
        </section>
        ...
        <section class="">
            <?php require("Script/Contact/contact.php"); ?>
        </section>
